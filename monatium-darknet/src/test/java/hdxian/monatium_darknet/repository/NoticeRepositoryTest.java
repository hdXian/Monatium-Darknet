...
//    @Rollback(value = false)
    void save() {
        ...
        // when
        Notice notice = Notice.createNotice(lily, noticeCategory, "공지사항제목", "공지사항본문");
...
//    @Rollback(value = false)
    void findByCharacterId() {
        ...
        // 공지 3개
        Notice notice1 = Notice.createNotice(lily, category, "릴리 공지 제목", "릴리 공지 본문");
        Notice notice2 = Notice.createNotice(lily, category, "릴리 이벤트 제목", "릴리 이벤트 본문");

        Notice notice3 = Notice.createNotice(amelia, category, "아멜리아 공지 제목", "아멜리아 공지 본문");
...
//    @Rollback(value = false)
    void findByCategory() {
        ...
        // 공지 2개
        Notice notice1 = Notice.createNotice(lily, category1, "릴리 공지1 제목", "릴리 공지1 본문");
        Notice notice2 = Notice.createNotice(amelia, category1, "아멜리아 공지2 제목", "아멜리아 공지2 본문");

        // 이벤트 2개
        Notice event1 = Notice.createNotice(lily, category2, "릴리 이벤트1 제목", "릴리 이벤트1 본문");
        Notice event2 = Notice.createNotice(amelia, category2, "아멜리아 이벤트2 제목", "아멜리아 이벤트2 본문");

        // 업데이트 3개
        Notice update1 = Notice.createNotice(lily, category3, "릴리 업데이트1 제목", "릴리 업데이트1 본문");
        Notice update2 = Notice.createNotice(lily, category3, "릴리 업데이트2 제목", "릴리 업데이트2 본문");
        Notice update3 = Notice.createNotice(amelia, category3, "아멜리아 업데이트3 제목", "아멜리아 업데이트3 본문");

        // 개발자 노트 1개
        Notice dev1 = Notice.createNotice(amelia, category4, "아멜리아 개발자노트1 제목", "아멜리아 개발자노트1 본문");
