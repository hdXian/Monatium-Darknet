...
public class Aside {
    ...
    public static Aside createAside(String name, String description, Character character, AsideSpec lv1, AsideSpec lv2, AsideSpec lv3) {
        Aside aside = new Aside();
        aside.setName(name);
        aside.setDescription(description);
        aside.setCharacter(character);
        aside.setLevel1(lv1);
        aside.setLevel2(lv2);
        aside.setLevel3(lv3);
