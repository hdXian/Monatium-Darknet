...
@Entity
@Table(name = "character_en")
@Getter @Setter
public class CharacterEn{

    @Id @GeneratedValue
    @Column(name = "character_en_id")
    private Long id; // id
...
//            aside.setCharacter(this);
    ...
    // 생성 메서드
    public static CharacterEn createCharacterEn(LangCode langCode, String name, String subtitle, String cv,
